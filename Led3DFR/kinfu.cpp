...
int ___main(int argc, char **argv)
{
	...
	Ptr<DepthSource> ds;
	ds = makePtr<DepthSource>("D:/Dataset/rgbd_dataset_freiburg3_large_cabinet/rgbd_dataset_freiburg3_large_cabinet/depth.txt");
	//if (parser.has("depth")) {
	//	std::cout << parser.get<String>("depth") << std::endl;
